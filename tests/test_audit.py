...
def test_run_audit_with_mocked_model(radiant, adapter, db_path):
    ...
    with patch("xibi.radiant.get_model", return_value=mock_model), \
...
def test_summary_audit_cycles_since(radiant, db_path):
    with open_db(db_path) as conn, conn:
        ...
        conn.execute("INSERT INTO observation_cycles (completed_at, signals_processed) VALUES ('2023-01-01 11:00:00', 1)")
        conn.execute("INSERT INTO observation_cycles (completed_at, signals_processed) VALUES ('2023-01-01 12:00:00', 1)")
        conn.execute("INSERT INTO observation_cycles (completed_at, signals_processed) VALUES ('2023-01-01 13:00:00', 1)")
