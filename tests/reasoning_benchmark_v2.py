...
def run_single_test(prompt, evaluate_fn, iteration):
    ...
    try:
        ...
        raise NotImplementedError(
            "Replace this block with your actual ReAct loop invocation. See comments above for options."
        )
...
def aggregate_results(results):
    ...
    for metric in sorted(all_metrics):
        ...
        metric_rates[metric] = {"passed": count, "total": total, "rate": round(count / total * 100, 1)}
...
def main():
    ...
    all_results["test_2_entity_chain"] = {"aggregate": test2_agg, "iterations": test2_results}
