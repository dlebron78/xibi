...
def lookup_contact(params: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "display_name": sanitize_untrusted_text(contact.get("display_name"), source="display_name"),
        "organization": sanitize_untrusted_text(contact.get("organization"), source="organization"),
        ...
        "tags": tags,
        "notes": sanitize_untrusted_text(contact.get("notes"), max_len=200, source="notes"),
